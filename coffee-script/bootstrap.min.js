...
(function() {
  define('cs!controllers/base',['jquery', 'weld'], function($, weld) {
    var Base;
    return Base = (function() {
      Base.prototype.el = null;
      Base.prototype.events = {};
      Base.prototype.template = null;
      function Base() {
        var action, cb, event, selector, _ref, _ref2;
        _ref = this.events;
        for (event in _ref) {
          cb = _ref[event];
          _ref2 = event.split(' '), action = _ref2[0], selector = _ref2[1];
          $('body').on(action, selector, this[cb]);
        }
      }
      Base.prototype.render = function(data) {
        this.el.html(this.template);
        return weld(this.el[0], data);
      };
      return Base;
    })();
  });
...
define('text!templates/tmpl.html',[],function () { return '<div>\n  <h1 class="title">\n    <span class="price"></span>\n  </h1>\n  <p class="date"></p>\n\n</div>\n';});

(function() {
  define('cs!datas/data',{
    title: 'LyonJS',
    date: '29/11/2011',
    price: 'free'
  });
...
(function() {
  ...
  define('cs!controllers/hello',['cs!controllers/base', 'jquery', 'text!templates/tmpl.html', 'cs!datas/data'], function(Base, $, tmpl, data) {
    var Controller;
    return Controller = (function() {
      ...
      Controller.prototype.el = $('#main');
      Controller.prototype.events = {
        'click input.show': 'show',
        'click input.hide': 'hide'
      };
      Controller.prototype.template = tmpl;
      Controller.prototype.show = function(event) {
        console.log('show');
        this.render(data);
      ...
      Controller.prototype.hide = function() {
        ...
        return $(event.target).addClass('show');
      };
      return Controller;
    })();
  });
